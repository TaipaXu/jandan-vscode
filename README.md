...
JanDan is an unofficial VS Code extension for [jandan.net](https://jandan.net/). It adds a JanDan activity bar view for browsing hot lists, fresh posts, image comments, casual photos, cross-dressing posts, and support links without leaving VS Code.
...
- Activity bar container with Hot Lists, Fresh News, Boring Pics, Casual Photos, Cross-Dressing, and Support views.
