...
JanDan 是一个非官方的 [煎蛋](https://jandan.net/) VS Code 扩展。它在活动栏中提供煎蛋视图，可以直接浏览热榜、新鲜事、无聊图、随手拍、女装、树洞和支援链接。
...
- 活动栏中包含热榜、新鲜事、无聊图、随手拍、女装、树洞和支援煎蛋视图。
- 热榜视图包含 4 小时热榜、无聊图、树洞、随手拍、3 日最佳和 7 日最佳分类。
- 支持上一页、下一页和刷新操作。
